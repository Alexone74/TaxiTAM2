...
def converti_txt_a_json(input_file, output_file):
    ...
    try:
        ...
        # Mantieni l'ordine desiderato delle categorie invece di ordinarle alfabeticamente
        ordine_categorie = [
            "Geografia",
        ...
        # Converti il set delle categorie in lista con l'ordine specificato
        quiz_data["categorie"] = [cat for cat in ordine_categorie if cat in quiz_data["categorie"]]
